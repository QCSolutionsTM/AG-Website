    ...
    <div class="footer-content">
        ...
        <div class="footer-column">
            ...
            <ul class="footer-contact">
                ...
                <li><i class="fa fa-map-marker"></i> Willamette Valley, OR</li>
            </ul>
            <button class="footer-google-button">Click here to leave us a review on Google!</button>
        </div>
    </div>
    <div class="footer-bottom">
        <p>Privacy Policy | Terms of Service © Copyright Roof It All | All Rights Reserved.</p>
        <p>Powered by webdev.com</p>
    </div>
</footer>
